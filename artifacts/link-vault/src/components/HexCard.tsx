          ...
          <div className="absolute inset-0 z-20 pointer-events-none">
            <div
              ...
              style={{
                ...
                width: `${hexTextMaxWidthPx(titlePosition.y)}px`,
                maxWidth: `${hexTextMaxWidthPx(titlePosition.y)}px`,
            ...
            <div
              ...
              style={{
                ...
                transform: 'translate(-50%, -50%)',
                width: `${hexTextMaxWidthPx(descriptionPosition.y)}px`,
                maxWidth: `${hexTextMaxWidthPx(descriptionPosition.y)}px`,
